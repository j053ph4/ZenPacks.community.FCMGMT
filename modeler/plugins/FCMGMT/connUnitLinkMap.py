...
__doc__ = """connUnitLinkMap

connUnitLinkMap detects Conn Unit Links
This version adds a relation to associated connUnits and devices.
...
class connUnitLinkMap(SnmpPlugin):
    ...
    def process(self, device, results, log):
        ...
        for trunk in trunktable.values():
            ...
            if '\\x' in repr(om.connUnitLinkAgentAddressY):
                om.connUnitLinkAgentAddressY = self.dotify(om.connUnitLinkAgentAddressY)
            ...
            if om.connUnitLinkAgentAddressY != '0000000000000000':
